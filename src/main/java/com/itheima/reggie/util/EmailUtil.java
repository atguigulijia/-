...
public class EmailUtil {
    private static final String EMAIL_HOSTNAME = "smtp.qq.com";    //qq
    ...
    public static char[] sendLoginCodeByEmail(String accpectAccount)   {
        try {
            ...
            email.setTextMsg("你好，欢迎使用瑞吉外卖，你的验证码为" + String.valueOf(verifiCode) + ",有效时间为3分钟");
            email.send();
            return verifiCode;
